...
const ChatManager: React.FC<ChatManagerProps> = ({
  ...
  return (
    <div className="fixed bottom-16 md:bottom-0 right-0 z-50 flex flex-col lg:flex-row items-end gap-2 p-2 lg:p-4 lg:pr-[312px] pointer-events-none">
      <div className="flex flex-col lg:flex-row items-end gap-2 pointer-events-auto">
